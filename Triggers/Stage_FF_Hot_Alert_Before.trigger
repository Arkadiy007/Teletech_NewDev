...
/*	HotAlertsCustomSettings_EpsilonLoad__c hotAlertsEpsilonSettings = HotAlertsCustomSettings_EpsilonLoad__c.getOrgDefaults();
	if (hotAlertsEpsilonSettings == null || hotAlertsEpsilonSettings.Description__c == null || hotAlertsEpsilonSettings.Origin__c == null
	    || hotAlertsEpsilonSettings.Owner__c == null || hotAlertsEpsilonSettings.Priority__c == null || hotAlertsEpsilonSettings.Record_Type__c == null
	    || hotAlertsEpsilonSettings.Status__c == null || hotAlertsEpsilonSettings.Subject__c == null) {

		if (hotAlertsEpsilonSettings == null) {
			hotAlertsEpsilonSettings = new HotAlertsCustomSettings_EpsilonLoad__c();
		}

		hotAlertsEpsilonSettings.Description__c = 'Follow up on Lead Survey Hot Alert';
		hotAlertsEpsilonSettings.Origin__c = 'Lead Survey';
		hotAlertsEpsilonSettings.Owner__c = 'MCC Lead Hot Alert';
		hotAlertsEpsilonSettings.Priority__c = 'Low';
		hotAlertsEpsilonSettings.Record_Type__c = 'Lead Survey';
		hotAlertsEpsilonSettings.Status__c = 'Item Created';
		hotAlertsEpsilonSettings.Subject__c = 'Lead Survey Hot Alert';
		upsert hotAlertsEpsilonSettings;
		hotAlertsEpsilonSettings = HotAlertsCustomSettings_EpsilonLoad__c.getOrgDefaults();
	}*/

	//HotAlertsSettings__c hotAlertsSettings = HotAlertsSettings__c.getOrgDefaults();
