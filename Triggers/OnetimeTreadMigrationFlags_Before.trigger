...
trigger OnetimeTreadMigrationFlags_Before on OnetimeTreadMigration_Flags__c (before insert)  { 
	...
	for(OnetimeTreadMigration_Flags__c onetimeMigration : trigger.new){
		...
		if(ca != null && !checkDuplic.contains(ca.ID)){
			...
			ca.CASunsetMigrationDocumentID__c = onetimeMigration.Document_ID_Case_Number__c;
			// fire indicator
			if(onetimeMigration.Fire_Flag__c != null && (onetimeMigration.Fire_Flag__c.equals('Y') || onetimeMigration.Fire_Flag__c.equals('y'))){
				ca.Fire_Indicator__c = true;
				ca.Fire_Date__c = onetimeMigration.Fire_Date__c;
				nullFields = false;
			}else if(onetimeMigration.Fire_Flag__c != null){
			...
			if(onetimeMigration.Death_Injury_Flag__c != null && (onetimeMigration.Death_Injury_Flag__c.equals('Y') || onetimeMigration.Death_Injury_Flag__c.equals('y'))){
				ca.Injury_Indicator__c = true;
				ca.Injury_Date__c = onetimeMigration.Death_Injury_Date__c;
				nullFields = false;
			}else if(onetimeMigration.Death_Injury_Flag__c != null){
			...
			if(onetimeMigration.Goodwill_Flag__c != null && (onetimeMigration.Goodwill_Flag__c.equals('Y') || onetimeMigration.Goodwill_Flag__c.equals('y'))){
				ca.Goodwill_Offered__c = true;
				ca.Goodwill_Offered_Date__c = onetimeMigration.Goodwill_Date__c;
				nullFields = false;
			}else if(onetimeMigration.Goodwill_Flag__c != null){
			...
			if(onetimeMigration.Property_Damage_Flag__c != null && (onetimeMigration.Property_Damage_Flag__c.equals('Y') || onetimeMigration.Property_Damage_Flag__c.equals('y'))){
				ca.Property_Damage_Indicator__c = true;
				ca.Property_Damage_Date__c = onetimeMigration.Property_Damage_Date__c;
				nullFields = false;
			}else if(onetimeMigration.Property_Damage_Flag__c != null){
			...
			//rollover indicator
			if(onetimeMigration.Rollover_Flag__c != null && (onetimeMigration.Rollover_Flag__c.equals('Y') || onetimeMigration.Rollover_Flag__c.equals('y'))){
				ca.Rollover_Indicator__c = true;
				ca.Rollover_Date__c = onetimeMigration.Rollover_Date__c;
				nullFields = false;
			}else if(onetimeMigration.Rollover_Flag__c != null){
			...
			if(onetimeMigration.Sent_to_Legal_Flag__c != null && (onetimeMigration.Sent_to_Legal_Flag__c.equals('Y') || onetimeMigration.Sent_to_Legal_Flag__c.equals('y'))){
				ca.Sent_to_Legal_Indicator__c = true;
				ca.Sent_to_Legal_Date__c = onetimeMigration.Sent_to_Legal_Date__c;
				nullFields = false;
			}else if(onetimeMigration.Sent_to_Legal_Flag__c != null){
			...
			if(nullFields){
				onetimeMigration.Successful__c = false;
				onetimeMigration.Error_Description__c = 'All flags have null values';
			}else{
				//add to maps			
